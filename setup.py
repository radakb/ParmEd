...
packages = ['parmed', 'parmed.amber', 'parmed.modeller',
            ...
            'parmed.charmm', 'parmed.namd', 'parmed.formats.pdbx', 
            'parmed.rosetta', 'parmed.formats', 'parmed.utils.fortranformat', 
            'parmed.openmm', 'parmed.utils', 'parmed.gromacs', 'parmed.tools',
